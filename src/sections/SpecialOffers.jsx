  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      <div className="flex-1">
        <img src={offer} alt="offer-images" className="object-contain w-full" width={773} height={687}/>
      </div>
      ...
      <div className="flex flex-1 flex-col">
        <h1 className="font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
          ...
          redefines your experience with unbeatable deals. From premier selections to incredible
